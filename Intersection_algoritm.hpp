...
bool out_range(const  Gabarit <POINT_TYPE> &a, const Gabarit <POINT_TYPE> &b, bool equal = false)
{
	if (equal)
	{
...
{
	//Gabarit <POINT_TYPE> g1(POINT_TYPE const x11, POINT_TYPE const y11, POINT_TYPE const x12, POINT_TYPE const y12);
	//Gabarit <POINT_TYPE> g2(POINT_TYPE const x21, POINT_TYPE const y21, POINT_TYPE const x22, POINT_TYPE const y22);
	...
	if (out_range(g1, g2, equal))	return 0;
